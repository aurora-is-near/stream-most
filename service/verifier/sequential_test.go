...
func TestNearV3HeadersOnly(t *testing.T) {
	runTestCases(t, formats.NearV3, true, map[error][]string{
		...
		ErrFilteredShard: {
			...
			"5.0 5.1 0,2+1",
			"100 100.1 2-10+50",
			"1000.99 1000.100 0-99+2",
			"1000.99 1000.100 -+101",
		},
		ErrLowHeight: {
			"1 0",
			"1.0 0",
		...
		ErrLowShard: {
			...
			"5.6 5.6",
			"5.6 5.3",
			"5.6 5.3 0-5,7-100+100",
			"5.6 5.0",
			"5.6 5.0 0",
			"100.1000 100.1000",
			"100.1000 100.1000 999-1001+1",
			"100.1000 100.999",
			"100.1000 100.999 998,999,1000",
			"100.1000 100.500",
			"100.1000 100.500 0,10,500+10",
		},
		ErrUnannouncedBlock: {
			"0 1.1",
			"0 1.1 1+1",
			...
			"7 120.5 0-100+100",
			"7.119 120.0",
			"7.119 120.0 0,119,120",
			"7.99 120.1",
			"7.99 120.1 0,1,7,120",
			"7.99 120.98",
			"7.99 120.98 97-99+5",
			"7.99 120.99",
			"7.99 120.99 0-99",
			"7.99 120.100",
			"7.99 120.100 100-200+1",
		},
	})
}

func TestNearV3(t *testing.T) {
	runTestCases(t, formats.NearV3, false, map[error][]string{
		nil: {
			// TODO
		},
		ErrFilteredShard: {
